...
class CommonClass(models.Model):
    _name = "shopify_odoo_connector_sp.common"
    ...
    from_instance = fields.Many2one("shopify_odoo_connector_sp.instance_tbl", String="From Instance", ondelete="cascade")
    to_instance = fields.Many2one("shopify_odoo_connector_sp.instance_tbl", String="To Instance", ondelete="cascade")
    ...
    def get_last_sync_date(self, cron_type=0, action_type=None, to_instance_id=None, from_instance_id=None):
        ...
        if action_type == '1':      # FOR IMPORT ACTION
            get_last_sync_data = self.env['shopify_odoo_connector_sp.common'].search([
                ...
                try:
                    if inserted_cron_data:
                        ...
                        if not get_cron_data:
                            ...
                            insert_cron = self.env['shopify_odoo_connector_sp.common'].create(insert_cron_data)
        ...
        if all_products_ids:
            ...
            if shop_connection:
                ...
                if not inserted_cron_data:
                    check_cron_is_exists_or_not = self.env['shopify_odoo_connector_sp.common'].search([
