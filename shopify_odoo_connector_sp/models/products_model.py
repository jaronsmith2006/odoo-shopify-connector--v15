...
class SalesProductsClass(models.Model):
    ...
    instance = fields.Many2one("shopify_odoo_connector_sp.instance_tbl", String="Instance", ondelete="cascade")
...
class ProductModel(models.Model):
    ...
    exported_instance = fields.Many2many("shopify_odoo_connector_sp.instance_tbl", string="Exported Instance", default="")
    ...
    def create_variants(self):
        if self.product_options:
            variants = self.env['shopify_odoo_connector_sp.common'].create_variant_onchange('ds.products_variants_tbl', self.product_options, self.instance.id, self._origin.id)
    ...
    def edit_and_export_to_shopify(self):
        # is_exported = self.env["shopify_odoo_connector_sp.common"].edit_and_export_product_by_button(self, self.instance)
        is_exported = self.env["shopify_odoo_connector_sp.common"].edit_and_export_product_by_button(self)
...
class ProductImages(models.Model):
    ...
    def delete_product_image(self):
        ...
        if not is_delete:
            self.env["shopify_odoo_connector_sp.common"].write_error_log("Product Image delete in products_model.py file.", "Product Image not deleted properly.")


class ProductOptions(models.Model):
    _name = "ds.product_options"
    _description = "shopify_odoo_connector_sp.product_options"
...
class ProductOptionsValues(models.Model):
    ...
    _description = "shopify_odoo_connector_sp.product_options_values"
