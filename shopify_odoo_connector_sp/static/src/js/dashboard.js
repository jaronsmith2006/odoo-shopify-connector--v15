odoo.define('shopify_odoo_connector_sp.instance_tbl', function (require) {
"use strict";
...
//
    ...
    /* FOR PIE CHART OF PRODUCTS */
    render_project_task:function(){
        var self = this;
        var w = 400;
        var h = 400;
        var r = h/2;
        var elem = this.$('.shopify_products_graph');
