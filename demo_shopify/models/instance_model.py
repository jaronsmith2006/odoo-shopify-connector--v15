...
class InstanceClass(models.Model):
    _name = "demo_shopify.instance_tbl"
    _description = "demo_shopify.instance_tbl"
    ...
    def action_check_connection_for_store(self, record_data=None):
        update_record = {}
        shop_connection = self.env['demo_shopify.common'].action_check_connection(instance_data=record_data)
        state = '2'
