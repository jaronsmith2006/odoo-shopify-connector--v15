...
class InstanceClass(models.Model):
    _name = "shopify_odoo_connector.instance_tbl"
    _description = "shopify_odoo_connector.instance_tbl"
    ...
    def action_check_connection_for_store(self, record_data=None):
        update_record = {}
        shop_connection = self.env['shopify_odoo_connector.common'].action_check_connection(instance_data=record_data)
        state = '2'
