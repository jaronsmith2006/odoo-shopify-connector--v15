...
class OdooProductModel(models.Model):
    ...
    exported_in = fields.Many2many("shopify_odoo_connector.instance_tbl", string="Exported Instances")
    ...
    def create_variants(self):
        if self.product_options:
            variants = self.env['shopify_odoo_connector.common'].create_variant_onchange('ds.odoo_products_variants_tbl', self.product_options)
